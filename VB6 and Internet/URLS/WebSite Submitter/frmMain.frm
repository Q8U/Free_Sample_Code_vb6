...
Begin VB.Form frmMain 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "txtPhone"
      Tab(0).Control(1)=   "txtPostal"
      Tab(0).Control(2)=   "txtProvince"
      Tab(0).Control(3)=   "txtAddress"
      Tab(0).Control(4)=   "txtMail"
      Tab(0).Control(5)=   "txtCountry"
      Tab(0).Control(6)=   "txtCity"
      Tab(0).Control(7)=   "txtCompany"
      Tab(0).Control(8)=   "txtName"
      Tab(0).Control(9)=   "k16"
      Tab(0).Control(10)=   "k17"
      Tab(0).Control(11)=   "k18"
      Tab(0).Control(12)=   "k15"
      Tab(0).Control(13)=   "k14"
      Tab(0).Control(14)=   "k13"
      Tab(0).Control(15)=   "k10"
      Tab(0).Control(16)=   "k11"
      Tab(0).Control(17)=   "k12"
      Tab(0).Control(18)=   "k9"
      Tab(0).Control(19)=   "k8"
      Tab(0).Control(20)=   "k7"
      Tab(0).Control(21)=   "k4"
      ...
      Tab(0).Control(25)=   "k2"
      Tab(0).Control(26)=   "k1"
      Tab(0).Control(27)=   "CoCategory"
      Tab(0).Control(28)=   "txtDes"
      Tab(0).Control(29)=   "txtTitle"
      Tab(0).Control(30)=   "txtURL"
      Tab(0).Control(31)=   "CoUrl"
      Tab(0).Control(32)=   "imgButt"
      Tab(0).Control(33)=   "Label1(22)"
      Tab(0).Control(34)=   "Label1(20)"
      Tab(0).Control(35)=   "Label1(19)"
      Tab(0).Control(36)=   "Label1(13)"
      Tab(0).Control(37)=   "Label1(12)"
      Tab(0).Control(38)=   "Label1(11)"
      Tab(0).Control(39)=   "Label1(10)"
      Tab(0).Control(40)=   "Label1(9)"
      Tab(0).Control(41)=   "Label1(8)"
      Tab(0).Control(42)=   "Label1(7)"
      Tab(0).Control(43)=   "Label1(6)"
      Tab(0).Control(44)=   "Label1(5)"
      Tab(0).Control(45)=   "Label1(4)"
      Tab(0).Control(46)=   "Label1(3)"
      Tab(0).Control(47)=   "Label1(2)"
      Tab(0).Control(48)=   "Label1(1)"
      Tab(0).Control(49)=   "Label1(0)"
