...
'no success. It wasn't until a German U-Boat was forced to surface in a naval battle and was
...
'offense.
'
'This code is by no means complete. I will try and enhance it's speed and toughen it's encryption
'even further. I'll also try and build a better sample app with more features. If you find a
'problem or have a suggestion, I would love to hear it.
'
'God Bless and have a great time with the code!
'
'- Stranger
