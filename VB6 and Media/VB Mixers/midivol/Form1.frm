...
CommonDialog1.ShowOpen
  ...
  i = mciSendString("open " & CommonDialog1.filename & " type sequencer alias mid1", 0&, 0, 0)
...
Private Sub Timer1_Timer()
  Dim id As Long, v As Long, i As Long
    ...
    If VScroll1.Value = 2 And HScroll1.Value = -2 Then _
         i = midiOutSetVolume(id, 10280)
    If VScroll1.Value = 2 And HScroll1.Value = -1 Then _
         i = midiOutSetVolume(id, 379004968)
    If VScroll1.Value = 2 And HScroll1.Value = 0 Then _
         i = midiOutSetVolume(id, 673720360)
    If VScroll1.Value = 2 And HScroll1.Value = 1 Then _
         i = midiOutSetVolume(id, 673714578)
    If VScroll1.Value = 2 And HScroll1.Value = 2 Then _
         i = midiOutSetVolume(id, 673710080)
    
    If VScroll1.Value = 3 And HScroll1.Value = -2 Then _
         i = midiOutSetVolume(id, 20560)
    If VScroll1.Value = 3 And HScroll1.Value = -1 Then _
         i = midiOutSetVolume(id, 757944400)
    If VScroll1.Value = 3 And HScroll1.Value = 0 Then _
         i = midiOutSetVolume(id, 1347440720)
    If VScroll1.Value = 3 And HScroll1.Value = 1 Then _
         i = midiOutSetVolume(id, 1347429155)
    If VScroll1.Value = 3 And HScroll1.Value = 2 Then _
         i = midiOutSetVolume(id, 1347420160)
    
    If VScroll1.Value = 4 And HScroll1.Value = -2 Then _
        i = midiOutSetVolume(id, 31868)
    If VScroll1.Value = 4 And HScroll1.Value = -1 Then _
        i = midiOutSetVolume(id, 1174830204)
    If VScroll1.Value = 4 And HScroll1.Value = 0 Then _
        i = midiOutSetVolume(id, 2088533116)
    If VScroll1.Value = 4 And HScroll1.Value = 1 Then _
        i = midiOutSetVolume(id, 2088515191)
    If VScroll1.Value = 4 And HScroll1.Value = 2 Then _
        i = midiOutSetVolume(id, 2088501248)
    
    If VScroll1.Value = 5 And HScroll1.Value = -2 Then _
        i = midiOutSetVolume(id, 42919)
    If VScroll1.Value = 5 And HScroll1.Value = -1 Then _
        i = midiOutSetVolume(id, 1582213031)
    If VScroll1.Value = 5 And HScroll1.Value = 0 Then _
        i = midiOutSetVolume(id, -1482184793)
    If VScroll1.Value = 5 And HScroll1.Value = 1 Then _
        i = midiOutSetVolume(id, -1482208934)
    If VScroll1.Value = 5 And HScroll1.Value = 2 Then _
        i = midiOutSetVolume(id, -1482227712)
    
    If VScroll1.Value = 6 And HScroll1.Value = -2 Then _
        i = midiOutSetVolume(id, 54227)
    If VScroll1.Value = 6 And HScroll1.Value = -1 Then _
        i = midiOutSetVolume(id, 1554895827)
    If VScroll1.Value = 6 And HScroll1.Value = 0 Then _
        i = midiOutSetVolume(id, -741092397)
    If VScroll1.Value = 6 And HScroll1.Value = 1 Then _
        i = midiOutSetVolume(id, -741122899)
    If VScroll1.Value = 6 And HScroll1.Value = 2 Then _
        i = midiOutSetVolume(id, -741146624)
    
    If VScroll1.Value = 7 And HScroll1.Value = -2 Then _
        i = midiOutSetVolume(id, 65535)
    If VScroll1.Value = 7 And HScroll1.Value = -1 Then _
        i = midiOutSetVolume(id, -1878982657)
    If VScroll1.Value = 7 And HScroll1.Value = 0 Then _
        i = midiOutSetVolume(id, -1)
    If VScroll1.Value = 7 And HScroll1.Value = 1 Then _
        i = midiOutSetVolume(id, -36865)
    If VScroll1.Value = 7 And HScroll1.Value = 2 Then _
        i = midiOutSetVolume(id, -65536)
End Sub
