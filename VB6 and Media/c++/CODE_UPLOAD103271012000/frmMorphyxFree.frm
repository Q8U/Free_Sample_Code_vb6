...
Begin VB.Form frmMorphyxFree 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   480
      Left            =   120
      Picture         =   "frmMorphyxFree.frx":030A
      ScaleHeight     =   480
      ScaleWidth      =   480
      TabIndex        =   2
      Top             =   0
   ...
   Begin VB.PictureBox picTitle 
      ...
      Begin VB.Image btnClose 
         Height          =   210
         Left            =   6120
         Picture         =   "frmMorphyxFree.frx":0614
         ToolTipText     =   "Close"
         Top             =   30
         Width           =   240
      End
      Begin VB.Image imgCloseUp 
         Height          =   210
         Left            =   5400
         Picture         =   "frmMorphyxFree.frx":08F6
         Top             =   0
         Visible         =   0   'False
         Width           =   240
      End
      Begin VB.Image imgCloseDown 
         Height          =   210
         Left            =   5160
         Picture         =   "frmMorphyxFree.frx":0BD8
         Top             =   0
         Visible         =   0   'False
         Width           =   240
      End
      Begin VB.Image btnMin 
         Height          =   210
         Left            =   5880
         Picture         =   "frmMorphyxFree.frx":0EBA
      ...
      Begin VB.Image imgMinDown 
         Height          =   210
         Left            =   4680
         Picture         =   "frmMorphyxFree.frx":119C
         Top             =   0
         Visible         =   0   'False
         Width           =   240
      End
      Begin VB.Image imgMinUp 
         Height          =   210
         Left            =   4920
         Picture         =   "frmMorphyxFree.frx":147E
         Top             =   0
         Visible         =   0   'False
         Width           =   240
      End
