VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} PrintAllReport 
   Bindings        =   "PrintAll.dsx":0000
   BorderStyle     =   1  'Fixed Single
   Caption         =   "JobTracker - PrintAllReport (DataReport)"
   ClientHeight    =   8295
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   12000
   ...
   EndProperty
End
Attribute VB_Name = "PrintAllReport"
